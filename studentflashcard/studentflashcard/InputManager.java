...
public abstract class InputManager {
    ...
    public static File requestZipFile(JFrame frame,String title){
         JFileChooser fileChooser = new JFileChooser();
            ...
            //vikasini changed Cabra projects to projects
                FileNameExtensionFilter filter = new FileNameExtensionFilter(
                    "projects (*." + Zipper.EXTENSION + ")", Zipper.EXTENSION);
     ...
     */
    //Vikasini changed Cabra Input to Student Flascard Input
    ...
    public static String getUserInput(String whatToAskFor, String defaultText, boolean isCancelOK,JFrame frame){
        ...
        while(true){
           ...
           //vikasini changed Cabra Input to Student Falshcard Input
