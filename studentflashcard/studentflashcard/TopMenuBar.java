...
import static studentflashcard.About.TRACKING_URL_ADDON;
...
public class TopMenuBar extends JMenuBar{
    ...
    public TopMenuBar(final Controller controller,final GUI gui){
        ...
        //import and export
		JMenu importExport = new JMenu("Import/Export/Contact");
		...
		JMenuItem addressBook = new JMenuItem("Address Book", GUI
				.createImageIcon("AddressBook-icon-small.png"));
                addressBook.addActionListener(new AddressBookListener());
                importExport.add(addressBook);  
    ...
    class AddressBookListener implements ActionListener{
        ...
        @Override
                public void actionPerformed(ActionEvent e){
        	ContactInfo add = new ContactInfo(controller, gui);
                }
