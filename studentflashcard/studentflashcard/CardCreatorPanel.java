...
public class CardCreatorPanel extends JPanel{
    ...
    class AddPictureListener implements ActionListener{
        public void actionPerformed(ActionEvent e){
			...
			/*
			 * //turn it into an image ImageIcon imageToInsert =
			 * GUI.createImageIconFromFullPath(imageFile.getAbsolutePath());
			 * //resize it imageToInsert = new
			 * ImageIcon(GUI.scaleImage(imageToInsert.getImage(), 80, 80));
			 * 
			 * //set picture on image button
			 * addPictureButton.setIcon(imageToInsert);
			 * addPictureButton.setToolTipText(imageFile.getAbsolutePath());
			 * //store path to file in here
			 */
        }
    }
