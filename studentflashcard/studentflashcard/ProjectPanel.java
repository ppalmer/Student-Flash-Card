...
public class ProjectPanel extends JPanel{
    ...
    public ProjectPanel(Project project, ProjectListPanel listPanel){
        ...
        //create label for notes/cards... take plural into account
    ...
    private void showPopupMenu(MouseEvent event){
        ...
        menu.add(item);
        //email
		item = new JMenuItem("Email Project", createImageIcon("email_icon_small.gif"));
        item.addActionListener(new EmailListener());
        menu.add(item);
        //copy
		item = new JMenuItem("Copy project", createImageIcon("icon_small_copy.png"));
        item.addActionListener(new CopyListener());
        menu.add(item);
        
        item = new JMenuItem("Copy FlashCard", createImageIcon("icon_small_copy.png"));
        item.addActionListener(new CopyFlashCard());
    ...
    private void copyFlashCard(){
    	if(project != null)
    		listPanel.copyFlashCardProject(project);
    }
    ...
    private class CopyFlashCardListener implements ActionListener{
    	public void actionPerformed(ActionEvent e){
    		copyFlashCard();
    	}
    }
